import 'package:acatina_app/pages/ForgetPage/widget/verifyEmail.dart';
...
class ForgetPasswodSchool extends StatelessWidget {
  const ForgetPasswodSchool({super.key});
